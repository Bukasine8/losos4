...
export function ProjectManagementHeroSection() {
    const subtitleWords = [
        { text: "End-to-end" },
        { text: "engineering" },
        { text: "project" },
        ...
        <section className="relative h-[55vh] min-h-[500px] flex items-center justify-center overflow-hidden bg-slate-950">
            ...
            <div className="absolute inset-0 z-0">
                <div
                    ...
                    style={{
                        backgroundImage: "url('https://images.unsplash.com/photo-1542626991-cbc4e32524cc?q=80&w=2669&auto=format&fit=crop')",
                    }}
                />
            ...
            {/* Particle Field - Blue/Slate for Corporate theme */}
            ...
            <div className="container relative z-10 text-center px-4">
                ...
                >
                    <motion.div
                        ...
                        className="inline-block px-4 py-2 rounded-full glass border border-blue-500/20 mb-6"
                    >
                        <span className="text-sm font-medium text-blue-400">Services / Project Management</span>
                    </motion.div>
