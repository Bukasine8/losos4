...
export function BookingConfirmation({ data }: BookingConfirmationProps) {
    ...
    const handleAddToGoogleCalendar = () => {
        ...
        const description = `Meeting Type: ${data.meeting_type}\\nNotes: ${data.additional_notes || "N/A"}`;
        const location =
            ...
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Would you like to add this meeting to your Google Calendar?
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        ...
                        <Button onClick={handleAddToGoogleCalendar}>Add to Calendar</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
